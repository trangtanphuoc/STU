...
?>
	...
	<body>
	<div id="top">Quản Lý Ngân Hàng</div>
		<div id="main">
				...
				<div id="content">
					...
					<table align = "center" border = "1">
						...
						?>
								<tr>
									<td align="center"><?php echo $row["MaNH"];?></td>
									<td><?php echo $row["TenNH"];?>
									</td>
									<form method="post" action="suanganhang.php">	
									<td width="50" align="center">
									<button type = "submit" name = "Sua" value="<?php echo $row["MaNH"];?>" >Sửa </button></form></td>
									<form method="post" action="xoanganhang.php">	
									<td width="50" align="center">
									<button type = "submit" name = "Xoa" value="<?php echo $row["MaNH"];?>">Xóa </form></button></td>
								</tr>
								 <?php  } 
									mysqli_close($conn);
								 ?>
				...
				<div id ="right">
					<form  onsubmit="return xulyThem()" name="myForm"   method="post">
						Tên Ngân Hàng:  <input type="text" name = "TenNH"></br>
					...
					<?php 
						if(isset($_POST['Them'])){
							...
							$query = "SELECT * FROM nganhang WHERE TenNH='".$u."'";
							$result = mysqli_query($conn, $query);
							 if(mysqli_num_rows($result) != "" ){
								 echo "Tên Quận này đã tồn tại";
								  ...
								  $query = "INSERT INTO nganhang VALUES (NULL, '".$u."')";
								  $result = mysqli_query($conn, $query);
								  header("Refresh:0");
