<?php //ob_start();
   //$conn = mysqli_connect("mysql.hostinger.vn","u120233376_ten","11061986","u120233376_demo");
	...
	if( $_POST['TenTramXang'] == NULL || $_POST['DiaChi'] == NULL || $_POST['Rating'] == NULL ||$_POST['Lng'] == NULL ||$_POST['Lat'] == NULL){
	...
	$sl = "INSERT INTO tramxang VALUES (NULL, '$ten','$diachi','$rating','$lnt','$lat','$maquan')";
    if( mysqli_query($conn, $sl))
    {
        echo "<script language='javascript'>alert('Them thanh cong');";
		echo "location.href='tramxang.php';</script>";
    }
?>